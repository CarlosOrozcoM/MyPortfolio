# Personal Portfolio - Carlos Orozco
...
To run this project locally, simply clone the repository and open the `index.html` file in your preferred browser. Alternatively, you can run a local development server for better performance testing.
